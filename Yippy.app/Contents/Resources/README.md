...
- [x] Don’t let any of the app be used until access is granted
...
- [ ] Favourites
- [x] Search
- [ ] Improve search ranking/fuzzy search (maybe use https://github.com/krisk/fuse-swift)
- [x] Max history length
- [ ] Cell height cache improvements. Will improve window size changes and launch time.
    - [x] Find a cheap way to clear the cell height cache
